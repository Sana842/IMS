					    ...
					    <?php
                            if (isset($_POST['save'])) {
                              ...
                              $email=$_POST['email'];
                                ...
                                mysqli_query($conn,"insert into teacher (firstname,lastname,location,email,department_id)
								values ('$firstname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','$email','$department_id')") or die(mysqli_error()); ?>
								<script>
