                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Quiz url</label>
											<div class="controls">
											<input type="text" class="span8" name="url" id="inputPassword" placeholder="Quiz url" required>
											</div>
										</div>										
										<div class="control-group">
										<div class="controls">										
										...
										$url=$_POST['url'];
										mysqli_query($conn,"insert into quiz (quiz_title,quiz_description,date_added,teacher_id,url) values('$quiz_title','$description',NOW(),'$session_id','$url')")or die(mysqli_error());
										?>
										<script>
