...
<body>
                            ...
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
										...
										<div class="control-group">
											...
											<input type="number" class="span1" name="points" min=1 max=5  > 
											</div>
										</div> 
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">			
													<div id="opt11">
														...
														B: <input type="text" name="ans1" size="60"> <input name="answer" value="B" type="radio"><br><br>
														C: <input type="text" name="ans1" size="60"> <input name="answer" value="C" type="radio"><br><br>
														D: <input type="text" name="ans1" size="60"> <input name="answer" value="D" type="radio"><br><br>
													</div>
													<div id="opt12">
		...
		if ($type  == '2'){
				mysqli_query($conn,"insert into quiz_question (quiz_id,question_text,date_added,answer,question_type_id,points) 
			values('$get_id','$question',NOW(),'".$_POST['correctt']."','$type','$points')")or die(mysqli_error());
		}else{
	
		mysqli_query($conn,"insert into quiz_question (quiz_id,question_text,date_added,answer, points,question_type_id) 
		values('$get_id','$question',NOW(),'$ans1','$points','$type')")or die(mysqli_error());
