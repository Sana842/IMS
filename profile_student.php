...
<input type="text" class="form-control" id="email" name="username" placeholder="User Name" value="<?php  echo $row['username'];?> " readonly />


           <label>Student ID No.</label>
           <input type="text" class="form-control"  name="tech" placeholder="ID" value="<?php  echo $row['student_id'];?>" readonly />
            
           <label>Email ID </label>
           <input type="text" class="form-control"  name="tech" placeholder="ID" value="<?php  echo $row['email'];?>" readonly />
...
mysqli_query($conn,"update student set firstname = '$firstname' , lastname = '$lastname',username='$user' where student_id = '$session_id' ")or die(mysqli_error());	
